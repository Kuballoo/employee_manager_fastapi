...
from .models import Users
def has_permission(user_uuid: str, perm_list: list[str], db, all_required: bool = False) -> bool:
    """
    ...
    return all(perms_flags.values()) if all_required else any(perms_flags.values())
